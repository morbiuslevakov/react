        ...
        <Box className="telegram-card-wrapper" style={{"position":"relative"}}>
            <Box className="telegram-card">
                <div className="telegram-card-header">
                    <Typography className="telegram-card-header-text" style={{"color": "#004444", "fontFamily": "Montserrat, sans-serif", "margin": "auto", "fontSize": "2rem"}} fontWeight={300}>telegram bot</Typography>
                ...
                <div className="telegram-card-description">
                    <Typography style={{"color": "#717171", "fontFamily": "Montserrat, sans-serif", "margin": "auto", "fontSize":"1rem"}}>
                        <span style={{"color": "#ffffff", "backgroundColor": "#004444"}}>yusraBot</span> - telegram бот, обеспечивающий безопасный, быстрый и простой способ работы со всеми нашими продуктами. Он так же функционален, как и наша веб-платформа, но доступен из мессенджера Telegram. Бот сочетает в себе полную функциональность и оптимизированный пользовательский интерфейс.
                    </Typography>
