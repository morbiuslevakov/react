...
import { getUserTransactions } from "../../utils/api-utils";
...
export const UserTransactions = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            const resData = await apiRequest(getUserTransactions, email, type);
                        ...
                        <DefaultCard className={"glass svelte-10w51t0"}>
                            <CardContent style={{"display": "block!important", "alignItems": "left"}}>
                                <Stack style={{"marginBottom": "30px", "display":"block"}}>
                                    <Link to="/admin" style={{"display": "flex", "float": "left"}}>
                                        <BackArrowIcon/>
                                    </Link>
                                </Stack>
                                <Stack style={{"marginBottom": "30px", "display":"block"}}>
