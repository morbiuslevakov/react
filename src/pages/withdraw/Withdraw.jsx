            ...
            <SnackbarProvider maxSnack={2}>
                <PageContent>
                    ...
                    <Infographic titleFloat="right" textFloat="left" title=""
                                 text="Будьте осторожны при осуществлении вывода средств и внимательно проверьте адрес получателя, а также не забудьте указать мемо-фразу если того требует торговая площадка. С Уважением, команда YUSRA 👋"/>
                </PageContent>
            </SnackbarProvider>
        </Wrapper>
    );
